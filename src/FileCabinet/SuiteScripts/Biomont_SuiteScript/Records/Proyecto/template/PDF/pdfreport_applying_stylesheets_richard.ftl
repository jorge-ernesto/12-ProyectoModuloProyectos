    ...
    <body>
        ...
        <table class="items" width="100%" style="font-size: 7pt; border-collapse: collapse;" cellpadding="4">
            ...
            <tbody>
                ...
                <tr>
                    <td class="celda-body" colspan="5">${params.project_data.aprobado_por}</td>
                </tr>
                ...
                <tr>
                    <td class="celda-body" colspan="2"><b>Autorizado por:</b></td>
                    <td class="celda-body" colspan="3"><b>Comentarios:</b></td>
                </tr>
                <tr>
                    <td class="celda-body" colspan="2">${params.project_data.autorizado_por}</td>
                    <td class="celda-body" colspan="3">${params.project_data.comentarios_autorizado_por}</td>
                </tr>
                ...
                <tr>
                    <td class="celda-body" colspan="2"><b>Aprobado por:</b></td>
                    <td class="celda-body" colspan="3"><b>Comentarios:</b></td>
                </tr>
                <tr>
                    <td class="celda-body" colspan="2">${params.project_data.cierre_aprobado_por}</td>
                    <td class="celda-body" colspan="3">${params.project_data.coment_cierre_aprobado_por}</td>
                </tr>
