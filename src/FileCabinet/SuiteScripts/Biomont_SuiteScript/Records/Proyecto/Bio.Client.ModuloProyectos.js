    ...
    function (N) {
        ...
        function habilitarCamposPorTipo(recordContext, id) {
            ...
            */
            ...
            // Si se selecciona combo "Proyecto"
            if (comboTipo == 1) {
            ...
            // Si se selecciona combo "Control de Cambio"
            if (comboTipo == 2) {
        ...
        function sendRequest(method, comentarios = '') {
            ...
            let solicitado_por_id = recordContext.getValue('custentity_bio_solicitado_por');
            ...
            loadSweetAlertLibrary().then(function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        // Ejecutar peticion
                        sendRequestWrapper('noAutorizarProyecto');
                    }
                });
            });
        }
